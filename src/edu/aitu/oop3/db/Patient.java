...
public class Patient {
    public static void main(String[] args) {
        ...
        try (Connection connection = DatabaseConnection.getConnection()) {
            ...
            insertUser(connection, "Kyle", "ProGamer@example.com");
            insertUser(connection, "Grok", "AI@example.com");
 ...
 """;
    ...
    private static void printAllUsers(Connection connection) throws SQLException {
        String sql = "select id, name, email from patient order by id";
        try (PreparedStatement stmt = connection.prepareStatement(sql);
