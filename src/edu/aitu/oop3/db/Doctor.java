...
public class Doctor {
    public static void main(String[] args) {
        ...
        try (Connection connection = DatabaseConnection.getConnection()) {
            ...
            insertUser(connection, "Steve", "Doctor@example.com");
            insertUser(connection, "Alina", "AlinaGirlSlayYeah@example.com");
 ...
 """;
    ...
    private static void printAllUsers(Connection connection) throws SQLException {
        String sql = "select id, name, email from doctor order by id";
        try (PreparedStatement stmt = connection.prepareStatement(sql);
